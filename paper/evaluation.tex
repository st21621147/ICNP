...
\begin{figure}[h]
    \centering
    \subfigure[]{\includegraphics[width=1.65in]{experiments/rssiHistograms.eps}}
    \hspace{0.01in}
    \subfigure[]{\includegraphics[width=1.4in]{experiments/rssiDistance.eps}}
...
\label{Simulations}
% Since it will take years of efforts to deploy our protocol and detect the animal 
In this section,  
