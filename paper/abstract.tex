...
We present extensive simulations and experiments that verify the scalability
...
To the best of our knowledge, this is the first detailed description of 
a encounter-registration protocol for real wireless mobile networks.
