...
#list1 = [0.3,0.25,0.3,0.15]
#list2 = [0.4,0.25,0.35,0.2]
#list3 = [1,0.75,0.85,0.95]
#total_width, n = 0.9,3
#width = total_width / n
...
#plt.savefig('figure9_B.eps', format='eps', bbox_inches='tight')

label = ("Species I","Species II","Species III")
x =list(range(len(label)))
list1 = [0.4,0.55,1]
list2 = [0.25,0.25,0.75]
list3 = [0.25,0.35,0.85]
list4 = [0.15,0.2,0.95]
total_width, n = 0.8,4
width = total_width / n
